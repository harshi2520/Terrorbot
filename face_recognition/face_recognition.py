...
while True:
        ...
        for(x,y,w,h) in faces:
            ...
            #     bot=telepot.Bot('6163980412:AAFHvdEbrTFN6T83DcG2SfESxFgKwq7CjDY')
            #     bot.sendMessage('5697717327',str(name))
            #     bot.sendPhoto('5697717327',photo=open('frame.png','rb'))
                ...
                cv2.imwrite('frame.png', im)
                # bot=telepot.Bot('6163980412:AAFHvdEbrTFN6T83DcG2SfESxFgKwq7CjDY')
            #     bot.sendMessage('5697717327',str('unknown detected'))
            #     bot.sendPhoto('5697717327',photo=open('frame.png','rb'))
            #     Send1()
